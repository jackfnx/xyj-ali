...
int main(object me, string arg)
{
    ...
    if ((me->query("family")) && (me->query("family/family_name") != ob->query("family/family_name")) && (me->query("family/family_name") != ob->query("second_family_name")))
...
*/
   ...
   if ((object)ob->query_temp("pending/recruit") == me) {
       if ((me->query("family/family_name") != ob->query("family/family_name")) && (me->query("family/family_name") != ob->query("second_family_name"))) {
           message_vision(
                   "$N决定投入$n门下！！\n\n"

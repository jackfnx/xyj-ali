...
# ÎªÁË·ÀÖ¹WINNTÏÂÖØÆôºóÎÞ·¨½ÓÈëËùÒÔ¿ªÁË1¸ö¶Ë¿Ú£¡
...
address server port : 2008

# absolute pathname of mudlib
mudlib directory : D:/Mudos/code

# absolute pathname of driver/config dir
binary directory : D:/Mudos/BIN
...
# it is exceeded.
# change by Sunyc
maximum evaluation cost : 80000000
...
default fail message : Ê²Ã´£¿

# default message when error() occurs (optional)
default error message : [1;33mÄã·¢ÏÖÊÂÇé²»´ó¶ÔÁË£¬µ«ÊÇÓÖËµ²»ÉÏÀ´¡£[0;37;0m

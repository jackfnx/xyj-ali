...
int cast(object me, object target)
{
    ...
    if ((int)me->query_skill("bagua-zhen", 1) < 30)
...
void npc_attack(object invoker, object target, string npc, object where)
{
    ...
    attacker->add_temp("apply/attack", (int)invoker->query_skill("bagua-zhen", 1));

// Npc: /daemon/class/shaolin/dao-xiang2.c
// Date: YZC 96/01/19
...
string ask_me_1()
{
	...
	ob = new("/d/suburb/xkx/shaolin/obj/jinchuang-yao");
	ob->move(this_player());
...
string ask_me_2()
{
	...
	ob = new("/d/suburb/xkx/shaolin/obj/xiaohuan-dan");
	ob->move(this_player());
...
string ask_me_3()
{
	...
	ob = new("/d/suburb/xkx/shaolin/obj/dahuan-dan");
	ob->move(this_player());

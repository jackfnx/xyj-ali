...
mixed hit_ob(object me, object victim, int damage_bonus)
{
    ...
    if (damage_bonus > 250 && userp(me)) return 0;
    if (me->query("force") < 200) return 0;
    if (me->query_temp("noauto") && random(15)!=1) return 0;
    if (!weapon || (string)weapon->query("material") != "ice") return 0;
    ...
    switch(random(3)) {
        case 0:
            ...
            break;
        case 1:
            victim->receive_damage("kee", damage_bonus/2);

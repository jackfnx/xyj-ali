...
mapping *action = ({
   ...
   ([   "action":     "$N忽然踏入「天璇」位，高叫一声：还不缚手就擒！手中的$w一绞，扫向$n$l",
     "dodge":     0,
     "parry":     -15,
     "damage":     15,
     "damage_type":   "砸伤"
   ]),
   ([   "action":     "$N踩住「天玑」位，手中的$w带出飞沙走石般的杖风压向$n的$l",
     "dodge":     5,
     "parry":     -5,
     "damage":     30,
     "damage_type":   "砸伤"
   ]),
   ([   "action":     "只见$N略略一退，恰好踏住「天权」位，旋即一个跨步，$w划出一道弧光刺向$n$l",
     "dodge":     5,
     "parry":     0,
     "damage":     20,
     "damage_type":   "刺伤"
   ]),
   ([   "action":     "$N横持$w，虚踏「玉衡」位，暗运真气，忽然间只见杖头一跳，灵蛇般钻向$n的$l",
     "dodge":     -5,
     "parry":     0,
     "damage":     15,
     "damage_type":   "刺伤"
   ]),
   ([   "action":     "$N脚踏「开阳」位，的$w望上一挑，中途却使了个巧劲，杖尾嗖！地一翻，砸向$n$l",
     "dodge":     -5,
     "parry":     -10,
     "damage":     25,
     "damage_type":   "砸伤"
   ]),
   ([   "action":     "$N在「摇光」位上仿佛扎了根，身形急转，杖随身转，手中的$w横扫向$n的$l",
     "dodge":     5,
     "parry":     -10,
     "damage":     25,
     "damage_type":   "砸伤"
